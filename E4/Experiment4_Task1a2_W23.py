...
v = np.array([[-1, -1, 3, 1, 0],
              [0, -1, 1, -1, 1]])  # Stoichiometry Matrix
...
for i in range(0, nT, 1):
    ...
    lb = [-1.0, -1.0]  # It is a reversible reaction, so the extent of reactions can be -1

    ub = [1.0, 1.0]  # Uppper bound for the extents of the reactions

    n0 = [0.1, 0.02]  # Solution is very sensitive to initial guess!!!!!!!!!
