...
plt.plot(x_actual, T_actual, label='Actual Bubble Point Curve')
plt.plot(y_actual, T_actual, label='Actual Dew Point Curve')
plt.title('T-XY for Ethanol-Water System at 32.86kPa')
plt.xlabel('X or Y')
plt.ylabel('T (K)')
plt.xlim(0, 1)
plt.legend()
